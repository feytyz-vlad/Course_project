...
1. Аналіз і моделювання
- Підтвердити основні сутності: User, Role, Car, Order (Rental), Payment, Damage, Manager/Admin.
- Побудувати ER-діаграму, визначити PK, FK, унікальні індекси (email).
